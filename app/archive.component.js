    ...
    return {
        ...
        execute: function() {
            ArchiveComponent = (function () {
                function ArchiveComponent(_archiveService, _routeParams) {
                    this._archiveService = _archiveService;
                    this._routeParams = _routeParams;
                }
                ArchiveComponent.prototype.ngOnInit = function () {
                    this.archive = this._archiveService.getArchive(this._routeParams.get("year"), this._routeParams.get("month"));
                };
                ArchiveComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [archive_service_1.ArchiveService, router_1.RouteParams])
                ], ArchiveComponent);
