System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PruebaComponent = (function () {
                function PruebaComponent() {
                    this.prueba = "Hola Mundo";
                    this.chao = "Chao!!, Espero verte pronto!";
                }
                PruebaComponent.prototype.saludo = function () {
                    console.log(this.prueba);
                };
                PruebaComponent.prototype.despedida = function () {
            ...
            exports_1("PruebaComponent", PruebaComponent);
        }
    }
});
